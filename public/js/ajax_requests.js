        ...
        success: (data) => {
          if (data) {
            ...
            if (
              ...
              alertMessage(
                'SSH Key does not exist. If you continue videos taken by the Robot will NOT be copied to the server. Please contact an Admin to attempt to resolve the issue.'
              );
            }

            alertMessage('In a moment, a window will appear, you may need to type \'yes\'' +
              ' and hit enter and then you need to type your robots PASSWORD and hit enter!'
            );
            let gen = {};
            gen.ip = vals[1];
